...
if(isset($_POST['btnSave'])){
    ...
    $mobimgSize = $_FILES['mobimg']['size'];
    $TargetDirectry = "./img/";
    $imgPath = $TargetDirectry.$mobimgName;
    move_uploaded_file($mobtempName,$imgPath);
    $sql = "INSERT INTO mobiles (id,MobileName,MobilePrice,MobileQuantity,MobileDesc,MonImgPath) VALUES (Null,'$Mobname','$MobPrice','$MobQunatity','$Mobdesc','$imgPath')";
